...
public class EmpleadoJpaController implements Serializable {
    ...
    public EmpleadoJpaController() {
        this.emf = Persistence.createEntityManagerFactory("Sesion03PU");
    }
    ...
    public Empleado findByDniAndUser(String dni, String user) {
        EntityManager cm = getEntityManager();
        try {
            List<Empleado> empleado = cm.createNamedQuery("Empleado.findByDniAndUser", Empleado.class)
